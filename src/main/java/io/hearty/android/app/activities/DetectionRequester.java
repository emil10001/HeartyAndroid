...
public class DetectionRequester implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    private void continueRequestActivityUpdates() {
        Log.d(TAG, "continueRequestActivityUpdates");
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        if (null != getRequestPendingIntent()) {
            Log.d(TAG, "createRequestPendingIntent null != getRequestPendingIntent");
            ...
            Log.d(TAG, "createRequestPendingIntent new pending intent");
